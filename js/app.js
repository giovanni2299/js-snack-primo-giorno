...
console.log('ESERCIZIO 1:',number); //number 
...
console.log('ESERCIZIO 2:',PI) //number
...
//const PI = 3.1416; //number //non funziona perchè const non è una variabile riassegnabile
...
console.log('ESERCIZIO 2/C:' ,circle) //number
...
console.log('ESERCIZIO 3:' ,name); //string
